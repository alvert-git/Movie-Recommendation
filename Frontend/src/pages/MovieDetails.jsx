...
const MovieDetails = () => {
    ...
    if (!movie) {
        return <div className="bg-black min-h-screen text-white flex justify-center items-center">Movie not found.</div>;
    }
        ...
        <div className="bg-black min-h-screen text-white">
            ...
            <div className="container mx-auto px-6 py-10">
                ...
                {recommendations.length > 0 ? (
                    ...
                    <p className="text-gray-500 italic">No recommendations found for this title.</p>
                )}
            </div>
        </div>
    );
